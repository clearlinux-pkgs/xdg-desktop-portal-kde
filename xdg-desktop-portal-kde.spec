...
Source0  : https://download.kde.org/stable/plasma/6.1.0/xdg-desktop-portal-kde-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/xdg-desktop-portal-kde-6.1.0.tar.xz.sig
...
%setup -q -n xdg-desktop-portal-kde-6.1.0
cd %{_builddir}/xdg-desktop-portal-kde-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718828936
mkdir -p clr-build
pushd clr-build
