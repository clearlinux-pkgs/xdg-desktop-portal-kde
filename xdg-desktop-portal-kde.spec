...
Source0  : https://download.kde.org/stable/plasma/6.1.1/xdg-desktop-portal-kde-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/xdg-desktop-portal-kde-6.1.1.tar.xz.sig
...
%setup -q -n xdg-desktop-portal-kde-6.1.1
cd %{_builddir}/xdg-desktop-portal-kde-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719427649
mkdir -p clr-build
pushd clr-build
