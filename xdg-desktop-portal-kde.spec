...
Source0  : https://download.kde.org/stable/plasma/6.3.1/xdg-desktop-portal-kde-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/xdg-desktop-portal-kde-6.3.1.tar.xz.sig
...
%setup -q -n xdg-desktop-portal-kde-6.3.1
cd %{_builddir}/xdg-desktop-portal-kde-6.3.1
pushd ..
cp -a xdg-desktop-portal-kde-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739910164
mkdir -p clr-build
pushd clr-build
