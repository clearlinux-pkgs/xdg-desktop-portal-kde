...
Source0  : https://download.kde.org/stable/plasma/6.2.0/xdg-desktop-portal-kde-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/xdg-desktop-portal-kde-6.2.0.tar.xz.sig
...
%setup -q -n xdg-desktop-portal-kde-6.2.0
cd %{_builddir}/xdg-desktop-portal-kde-6.2.0
pushd ..
cp -a xdg-desktop-portal-kde-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728689343
mkdir -p clr-build
pushd clr-build
