...
Source0  : https://download.kde.org/stable/plasma/5.25.2/xdg-desktop-portal-kde-5.25.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.2/xdg-desktop-portal-kde-5.25.2.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.25.2
cd %{_builddir}/xdg-desktop-portal-kde-5.25.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656442542
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/xdg-desktop-portal-kde-5.25.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/xdg-desktop-portal-kde-5.25.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/xdg-desktop-portal-kde-5.25.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/xdg-desktop-portal-kde-5.25.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/xdg-desktop-portal-kde-5.25.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/xdg-desktop-portal-kde-5.25.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
