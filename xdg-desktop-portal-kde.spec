...
Version  : 5.14.3
Release  : 8
URL      : https://download.kde.org/stable/plasma/5.14.3/xdg-desktop-portal-kde-5.14.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.3/xdg-desktop-portal-kde-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/xdg-desktop-portal-kde-5.14.3.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.14.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1541538694
mkdir -p clr-build
pushd clr-build
%cmake ..
