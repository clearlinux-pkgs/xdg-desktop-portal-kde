...
Source0  : https://download.kde.org/stable/plasma/6.0.4/xdg-desktop-portal-kde-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/xdg-desktop-portal-kde-6.0.4.tar.xz.sig
...
%setup -q -n xdg-desktop-portal-kde-6.0.4
cd %{_builddir}/xdg-desktop-portal-kde-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713299741
mkdir -p clr-build
pushd clr-build
