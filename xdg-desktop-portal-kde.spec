...
Source0  : https://download.kde.org/stable/plasma/6.1.3/xdg-desktop-portal-kde-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/xdg-desktop-portal-kde-6.1.3.tar.xz.sig
...
%setup -q -n xdg-desktop-portal-kde-6.1.3
cd %{_builddir}/xdg-desktop-portal-kde-6.1.3
pushd ..
cp -a xdg-desktop-portal-kde-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721158629
mkdir -p clr-build
pushd clr-build
