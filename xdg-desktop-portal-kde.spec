...
Version  : 5.27.8
Release  : 90
URL      : https://download.kde.org/stable/plasma/5.27.8/xdg-desktop-portal-kde-5.27.8.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.8/xdg-desktop-portal-kde-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/xdg-desktop-portal-kde-5.27.8.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.27.8
cd %{_builddir}/xdg-desktop-portal-kde-5.27.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694539566
mkdir -p clr-build
pushd clr-build
