...
Version  : 5.18.2
Release  : 42
URL      : https://download.kde.org/stable/plasma/5.18.2/xdg-desktop-portal-kde-5.18.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.18.2/xdg-desktop-portal-kde-5.18.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.18.2/xdg-desktop-portal-kde-5.18.2.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.18.2
cd %{_builddir}/xdg-desktop-portal-kde-5.18.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582747839
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/xdg-desktop-portal-kde-5.18.2/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-kde/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
