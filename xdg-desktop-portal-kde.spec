...
Source0  : https://download.kde.org/stable/plasma/5.13.4/xdg-desktop-portal-kde-5.13.4.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.4/xdg-desktop-portal-kde-5.13.4.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.13.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1535401337
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
