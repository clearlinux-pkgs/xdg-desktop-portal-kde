...
Version  : 5.27.7
Release  : 89
URL      : https://download.kde.org/stable/plasma/5.27.7/xdg-desktop-portal-kde-5.27.7.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.7/xdg-desktop-portal-kde-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/xdg-desktop-portal-kde-5.27.7.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.27.7
cd %{_builddir}/xdg-desktop-portal-kde-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690896092
mkdir -p clr-build
pushd clr-build
