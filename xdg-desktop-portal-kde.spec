...
Version  : 5.15.2
Release  : 13
URL      : https://download.kde.org/stable/plasma/5.15.2/xdg-desktop-portal-kde-5.15.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.15.2/xdg-desktop-portal-kde-5.15.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.2/xdg-desktop-portal-kde-5.15.2.tar.xz.sig
...
%prep
%setup -q -n xdg-desktop-portal-kde-5.15.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1551207626
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
